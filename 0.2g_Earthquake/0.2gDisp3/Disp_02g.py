# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 17:04:05 2020
@author: Bosh
"""
import os
import time
...
resultDir = '/share/home/bosh/nonlinear_seismic_response_analysis/August/0.2g_Earthquake/Disp/0.2gDisp3/'  
...
#-------------------------------------------------------------------------------
    model.save(resultDir+'8000epochs_model.h5')    
    end = time.time()
...
#-------------------------------------------------------------------------------
# Load the best model
ModelList = ['best_model','8000epochs_model']
